...
class OpticalFlowQuadTracker(
    ...
    fun update(
        ...
        if (fullDetectionRan) {
            ...
            if (quad == null) {
                prevQuadInFrame = null
                return TrackUpdate(null, TrackMode.FULL_DETECTION, 0f, 0, FullDetectionReason.TRACK_LOST)
            }
            ...
            if (!QuadValidator.isValid(
                ...
                prevQuadInFrame = null
                return TrackUpdate(null, TrackMode.FULL_DETECTION, 0f, 0, FullDetectionReason.INVALID_QUAD)
            }
            ...
            val publishedQuad = if (previousQuadInFrame != null &&
                QuadValidator.maxCornerDistance(quadInFrame, previousQuadInFrame) <= refreshAdoptDistance
            ) {
