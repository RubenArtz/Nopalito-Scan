            ...
            try {
                ...
                if (withContext(Dispatchers.IO) { isPdfEncrypted(cached) }) {
                    ...
                    _state.update {
                        it.copy(
                            isLoading = false,
                            isLoaded = false,
                            errorMessage = context.stringFor(R.string.dpp_error_protected, AppLocaleOverride.locale)
                        )
                    }
                    return@launch
                }
                ...
                _state.update {
                    it.copy(
                        isLoading = false,
                        isLoaded = false,
                        errorMessage = context.stringFor(R.string.dpp_error_invalid, AppLocaleOverride.locale)
                    )
                }
            }
        }
        ...
        if (toRemove.size >= st.pageOrder.size) {
            _state.update {
                it.copy(
                    ...
                    deleteDialogVisible = false,
                    results = emptyList(),
                    errorMessage = context.stringFor(R.string.dpp_cannot_delete_all, AppLocaleOverride.locale),
                )
            }
            return
        }
            ...
            try {
                ...
                _state.update {
                    it.copy(
                        ...
                        blankProgress = null,
                        blankProgressLabel = null,
                        errorMessage = context.stringFor(R.string.dpp_blank_analysis_failed, AppLocaleOverride.locale),
                    )
                }
            }
        }
            ...
            try {
                ...
                _state.update {
                    it.copy(
                        ...
                        progress = null,
                        progressLabel = null,
                        errorMessage = context.stringFor(R.string.dpp_error, AppLocaleOverride.locale)
                    )
                }
            }
        }
