...
import nopalito.app.ui.screens.cloud.screens.PcLinkScreen
        ...
        AnimatedContent(
            ...
            when (screen) {
                ...
                is CloudScreen.Home -> {
                    ...
                    val pcLinkVm: PcLinkViewModel = viewModel(factory = factory)
                    val pcLinkState by pcLinkVm.state.collectAsState()
                    ...
                    CloudHomeScreen(
                        ...
                        onNavigateToPcLink = { navigateTo(CloudScreen.PcLink) },
                        pcLinkBadge = pcLinkState.badge,
                        onBack = onBack,
                        onLogout = {
                            Log.i(
                                TAG,
                ...
                is CloudScreen.PcLink -> {
                    val vm: PcLinkViewModel = viewModel(factory = factory)
                    PcLinkScreen(
                        viewModel = vm,
                        onBack = { navigateTo(CloudScreen.Home) }
                    )
