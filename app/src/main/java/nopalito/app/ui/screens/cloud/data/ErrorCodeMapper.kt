...
object ErrorCodeMapper {
    ...
    private val SPECIFIC: Map<String, Int> = mapOf(
        ...
        "LINK_INTENT_NOT_FOUND" to R.string.cloud_link_error_intent_not_found,
        "LINK_SESSION_NOT_FOUND" to R.string.cloud_link_error_intent_not_found,
        "LINK_INTENT_EXPIRED" to R.string.cloud_link_error_intent_expired,
        "LINK_SESSION_EXPIRED" to R.string.cloud_link_error_intent_expired,
        "LINK_INTENT_BLOCKED" to R.string.cloud_link_error_intent_blocked,
        "LINK_INTENT_INVALID_STATE" to R.string.cloud_link_error_invalid_state,
        "LINK_PIN_INVALID" to R.string.cloud_link_error_invalid_state,
        "LINK_NONCE_MISMATCH" to R.string.cloud_link_error_invalid_state,
        "LINK_REFRESH_INVALID" to R.string.cloud_link_error_invalid_state,
        "LINK_OWNER_MISMATCH" to R.string.cloud_link_error_user_mismatch,
        "LINK_SESSION_REVOKED" to R.string.cloud_link_error_session_revoked,
    )
...
/**
 * Localized text for normalized [nopalito.app.ui.screens.cloud.model.PcLinkError]
 * failures (Cloud Link pairing). Transport-level cases (rate limit, network,
 * auth) reuse the shared cloud strings; pairing-specific cases have their own.
 */
object PcLinkErrorStrings {
    @StringRes
    fun resId(error: nopalito.app.ui.screens.cloud.model.PcLinkError): Int {
        return when (error) {
            is nopalito.app.ui.screens.cloud.model.PcLinkError.IntentNotFound ->
                R.string.cloud_link_error_intent_not_found

            is nopalito.app.ui.screens.cloud.model.PcLinkError.IntentExpired ->
                R.string.cloud_link_error_intent_expired

            is nopalito.app.ui.screens.cloud.model.PcLinkError.IntentBlocked ->
                R.string.cloud_link_error_intent_blocked

            is nopalito.app.ui.screens.cloud.model.PcLinkError.IntentInvalidState ->
                R.string.cloud_link_error_invalid_state

            is nopalito.app.ui.screens.cloud.model.PcLinkError.UserMismatch ->
                R.string.cloud_link_error_user_mismatch

            is nopalito.app.ui.screens.cloud.model.PcLinkError.RateLimited ->
                R.string.cloud_error_429

            is nopalito.app.ui.screens.cloud.model.PcLinkError.NetworkError ->
                R.string.cloud_link_error_network

            is nopalito.app.ui.screens.cloud.model.PcLinkError.Unauthorized ->
                R.string.cloud_link_error_session_revoked

            is nopalito.app.ui.screens.cloud.model.PcLinkError.Unknown ->
                R.string.cloud_link_error_unknown
        }
    }
}