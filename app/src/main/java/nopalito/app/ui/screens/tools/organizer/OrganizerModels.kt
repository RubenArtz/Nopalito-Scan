...
/** One exported file of the "Organize PDF pages" tool. */
...
data class OrganizerUiState(
     ...
     * Reordering moves entries; deleting removes them (undo keeps a snapshot).
    ...
    val results: List<OrganizerResult> = emptyList(),
    ...
    val undoStack: List<OrganizerUndoEntry> = emptyList(),
