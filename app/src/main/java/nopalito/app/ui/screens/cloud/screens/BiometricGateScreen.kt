...
fun BiometricGateScreen(
    ...
    val allowWeakForPrompt = remember {
        nopalito.app.ui.screens.cloud.security.BiometricWeakPreference.open(context).isWeakAccepted
    }
    val promptInfo = remember(allowWeakForPrompt) {
        buildBiometricPromptInfo(context, allowWeakForPrompt)
    }
