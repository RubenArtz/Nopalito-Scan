...
import nopalito.app.data.OcrLanguage.Companion.AVAILABLE_LANGUAGE_CODES
import java.io.File
...
class OcrLanguageRepository(
    ...
    private val _installedLanguagesFlow = MutableStateFlow<Set<String>>(emptySet())
    val installedLanguagesFlow: Flow<Set<String>> = _installedLanguagesFlow.asStateFlow()

    suspend fun refreshInstalledLanguagesFlow() {
        _installedLanguagesFlow.value = getInstalledLanguages()
    }
