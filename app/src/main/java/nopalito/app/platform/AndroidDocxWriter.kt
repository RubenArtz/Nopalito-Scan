        ...
        for ((index, page) in pages.withIndex()) {
            ...
            try {
                ...
                if (composedBitmap != null) {
                    try {
                        imageBytes = bitmapToPngBytes(composedBitmap)
                        isPng = true
                    } finally {
    ...
    private fun buildCorePropertiesXml(): String {
        ...
        return """
            ...
            <cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
              <dc:title>FairScan export</dc:title>
              <dc:creator>FairScan</dc:creator>
              <cp:lastModifiedBy>FairScan</cp:lastModifiedBy>
    ...
    private fun buildApplicationPropertiesXml(
        ...
        return """
            ...
            <Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">
              <Application>FairScan</Application>
              <DocSecurity>0</DocSecurity>
              <ScaleCrop>false</ScaleCrop>
              <Pages>$pageCount</Pages>
              <Company>FairScan</Company>
