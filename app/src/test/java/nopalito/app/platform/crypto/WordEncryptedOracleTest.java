...
/**
 * Test #2 (oráculo): descifra un .docx cifrado por Word de escritorio real y verifica
 * que el contenido recuperado es un ZIP válido (firma PK\x03\x04). Esto valida que
 * nuestra derivación de clave y esquema de IVs coinciden con la implementación de Word.
 */
