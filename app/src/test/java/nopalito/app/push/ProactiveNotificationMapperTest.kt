...
class ProactiveNotificationMapperTest {
    ...
    fun `quota_95 and quota_100 map to their own thresholds`() {
        val c95 = ProactiveNotificationMapper.contentFor("quota_95", quotaData + ("percent" to "97"))!!
        ...
        val c100 = ProactiveNotificationMapper.contentFor("quota_100", quotaData + ("percent" to "100"))!!
