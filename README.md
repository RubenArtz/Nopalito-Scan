...
<h3 align="center">
  <b>Get it on:</b>
  <a href="https://f-droid.org/en/packages/nopalito.app/">F-Droid</a> ·
  <a href="https://play.google.com/store/apps/details?id=nopalito.app">Google Play</a> ·
...
This feature is **experimental** and intended for developers who want to rely on FairScan as a simple,
privacy-respecting scanning tool. The intent contract and behavior may change between versions, and backward
compatibility is not guaranteed at this stage.

Intent action: `nopalito.app.action.SCAN_TO_PDF`
